...
class ComponentContactFormInquiryType extends BaseModel
{
    use SoftDeletes;
    use HasActivity;

    protected $table = 'component_contact_form_inquiry_types';
    ...
    {
        return ActivityType::C_CONTACT_FORM_INQUIRY_TYPE;
    }

    public function getActivitySubType(): string
    {
        return 'component_contact_form_inquiry_types';
    }
